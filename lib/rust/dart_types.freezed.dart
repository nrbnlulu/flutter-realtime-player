...
class StreamState_Init extends StreamState {
  const StreamState_Init({required this.sessionId}): super._();
...
$StreamState_InitCopyWith<StreamState_Init> get copyWith => _$StreamState_InitCopyWithImpl<StreamState_Init>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is StreamState_Init&&(identical(other.sessionId, sessionId) || other.sessionId == sessionId));
}
...
@override
String toString() {
  return 'StreamState.init(sessionId: $sessionId)';
}
...
/// @nodoc
abstract mixin class $StreamState_InitCopyWith<$Res> implements $StreamStateCopyWith<$Res> {
  factory $StreamState_InitCopyWith(StreamState_Init value, $Res Function(StreamState_Init) _then) = _$StreamState_InitCopyWithImpl;
@useResult
$Res call({
 PlatformInt64 sessionId
});
...
/// @nodoc
class _$StreamState_InitCopyWithImpl<$Res>
    implements $StreamState_InitCopyWith<$Res> {
  _$StreamState_InitCopyWithImpl(this._self, this._then);

  final StreamState_Init _self;
  final $Res Function(StreamState_Init) _then;

/// Create a copy of StreamState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? sessionId = null,}) {
  return _then(StreamState_Init(
