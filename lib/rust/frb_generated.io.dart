...
@protected RustStreamSink<StreamState> dco_decode_StreamSink_stream_state_Sse(dynamic raw);
...
@protected VideoInfo dco_decode_box_autoadd_video_info(dynamic raw);
...
@protected StreamState dco_decode_stream_state(dynamic raw);
...
@protected VideoDimensions dco_decode_video_dimensions(dynamic raw);

@protected VideoInfo dco_decode_video_info(dynamic raw);
...
@protected RustStreamSink<StreamState> sse_decode_StreamSink_stream_state_Sse(SseDeserializer deserializer);
...
@protected VideoInfo sse_decode_box_autoadd_video_info(SseDeserializer deserializer);
...
@protected StreamState sse_decode_stream_state(SseDeserializer deserializer);
...
@protected VideoDimensions sse_decode_video_dimensions(SseDeserializer deserializer);

@protected VideoInfo sse_decode_video_info(SseDeserializer deserializer);
...
@protected void sse_encode_StreamSink_stream_state_Sse(RustStreamSink<StreamState> self, SseSerializer serializer);
...
@protected void sse_encode_box_autoadd_video_info(VideoInfo self, SseSerializer serializer);
...
@protected void sse_encode_stream_state(StreamState self, SseSerializer serializer);
...
@protected void sse_encode_video_dimensions(VideoDimensions self, SseSerializer serializer);

@protected void sse_encode_video_info(VideoInfo self, SseSerializer serializer);
                }
