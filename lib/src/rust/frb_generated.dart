...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -519269190;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<void> crateApiSimpleDestroyPlayable(
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<void> crateApiSimpleDestroyPlayable(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiSimpleDestroyPlayableConstMeta,
      argValues: [textureId],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiSimpleDestroyPlayableConstMeta =>
      const TaskConstMeta(
        debugName: "destroy_playable",
        argNames: ["textureId"],
      );
