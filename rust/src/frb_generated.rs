...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -519269190;
...
fn wire__crate__api__simple__destroy_playable_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Result::<_, ()>::Ok({
                        crate::api::simple::destroy_playable(api_texture_id);
                    })?;
                    Ok(output_ok)
                })())
            }
...
fn wire__crate__api__simple__flutter_gstreamer_init_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "flutter_gstreamer_init",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Result::<_, ()>::Ok({
                        crate::api::simple::flutter_gstreamer_init(api_ffi_ptr);
                    })?;
                    Ok(output_ok)
                })())
            }
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        2 => wire__crate__api__simple__destroy_playable_impl(port, ptr, rust_vec_len, data_len),
        3 => {
            wire__crate__api__simple__flutter_gstreamer_init_impl(port, ptr, rust_vec_len, data_len)
        }
